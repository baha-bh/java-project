    ...
    <div style={{ display: 'flex', height: '100vh', alignItems: 'center', justifyContent: 'center' }}>
      <div className="glass-panel" style={{ width: '100%', maxWidth: '400px', padding: '2rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <h1 style={{ fontSize: '1.5rem', fontWeight: 'bold', color: 'var(--text-color)' }}>Вход в систему</h1>
          <p style={{ color: 'var(--text-color-muted)', fontSize: '0.875rem', marginTop: '0.5rem' }}>Введите данные для доступа к Normocontrol</p>
        </div>
